...
function MoviesGrid() {
 let titles = [
     "Mystical JavaScript and the Juggling Jinn",
     "Sorcerers of Syntax and the Serpent's Spell",
     "Coding Wizards and the Web's Wandering Wyverns",
     "Hexes, Hoisting, and the Howling Hocus-Pocus",
     "Enchanted Events and the Echoing Echidnas",
     "Charmed Callbacks and the Chimerical Chalice",
     "Array of Alchemy and the Artful Arachnomancer",
     "The Tricky Try-Catch and the Tale of Trolls",
     "Promises and Potions: The Pixie's Paradox",
     "Whimsical While Loops and the Wild Wolfen",
     "Intriguing Interfaces and the Illusionist's Iguana",
     "The Enigmatic ECMAScript and the Electric Eel",
     "Enchanting Objects and the Elemental Elves",
     "Casting Closures and the Cryptic Chimera",
     "The Magical Map of JSON and the Marvelous Manticore"
  ]
  ...
  const movies = [
    {
      ...
      "/src/img/19-removebg-preview.png",
        "/src/img/19.png",
        "https://static.vecteezy.com/system/resources/previews/028/394/878/non_2x/a-close-up-of-a-purple-and-green-forest-with-houses-generative-ai-photo.jpg",
    ...
    },
    {
      ...
      Images: [
        ...
        "/src/img/20-removebg-preview.png",

        "/src/img/28.png",

        "https://static.vecteezy.com/system/resources/previews/028/525/683/large_2x/world-environment-and-earth-day-with-nature-and-eco-friendly-environment-generative-ai-free-photo.jpeg",

        "https://static.vecteezy.com/system/resources/previews/014/779/075/large_2x/summer-landscape-with-trees-pond-and-beehive-free-vector.jpg",
    ...
    },
    {
      ...
      Images: [
        ...
        "/src/img/27-removebg-preview.png",

        "/src/img/18.png",

        "https://static.vecteezy.com/system/resources/previews/015/617/013/non_2x/beautiful-mountain-forest-and-river-landscape-background-vector.jpg",
    ...
    //     "/src/img/21-removebg-preview.png",

    //     "/src/img/4.png",
    //     "https://img.freepik.com/free-vector/campsite-with-bonfire-jungle-night_107791-16171.jpg",
  ...
  return (
    <div className="m-auto place-items-center grid ">
      <div className="grid md:grid-cols-3 gap-8 m-auto my-5 mb-20 ">
        {movies.map((item, index) => (
          <div className="card bg-base-100 " key={index}>
            <figure
              className="tilt-container h-full w-full glass rounded-t-none"
             
            >
              <img className="tilt" src={item.Images[1]} alt={item.Title} />
            </figure>
            <div className="card-body text-center w-12/12">
              {/* <h2 className="card-title mx-auto">{item.Title}</h2> */}
              <h2 className="card-title mx-auto w-2/3">{titles[index]}</h2>

              <Rating className=""></Rating>
              <div className="mb-1 mt-1  h-full align-baseline">
                {/* <p className="line-clamp-3 ">{item.Plot}</p> */}
                <p className="line-clamp-3 ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut exercitationem maxime, ab sapiente dolore quam adipisci animi eum maiores deleniti molestias harum iusto, iure consectetur, ipsa voluptas in quisquam officiis.</p>

              </div>
              <div className="text-center">
                <p className="text-xs">
                  <span className="text-slate-700">Directed by</span>{" "}
                  {item.Director}
                </p>
                <p className="text-xs ">
              ...
              <div className="card-actions justify-center mt-1">
                <button className="btn btn-tertiary btn-sm btn-wide">
                  Watch
                </button>
              </div>
            </div>
